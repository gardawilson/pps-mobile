...
class _SoV2ScanScreenState extends State<SoV2ScanScreen> {
  ...
  Future<void> _showManualInput() async {
    ...
    if (label != null && label.isNotEmpty) {
      await _confirmAndSubmit(label);
    }
  }

  Future<void> _confirmAndSubmit(String labelNo) async {
    if (_isProcessing) return;
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoRow(label: 'Label', value: labelNo),
            _InfoRow(
              label: 'Lokasi',
              value: widget.locationId == 0
                  ? 'Tidak diketahui'
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Nomor pallet',
                hintText: 'Isi bila label menggunakan pallet',
    ...
    final palletNo = palletController.text;
